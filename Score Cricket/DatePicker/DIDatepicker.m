...
- (void)setupViews
{
    ...
    self.bottomLineColor = [UIColor colorWithWhite:0.216 alpha:1.000];
...
- (void)selectDate:(NSDate *)date
{
    ...
    NSAssert([self.dates indexOfObject:[calendar dateFromComponents:todayComponents]] != NSNotFound, @"Date not found in dates array");
	
    self.selectedDate = [calendar dateFromComponents:todayComponents];
}
